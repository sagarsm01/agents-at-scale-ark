...
post-install-instructions: |
  Service is now running at: http://ark-cluster-memory:8080
```
...
- [ARK Cluster Memory](/developer-guide/services/ark-cluster-memory) - In-memory storage with SSE streaming support
